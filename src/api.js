...
async function getAccessToken() {
  ...
  if (!accessToken) {
    ...
    if (!code) {
      ...
      window.location.href = 'https://secure.meetup.com/oauth2/authorize?client_id=p5gcudadjt1as5fs4ddq45kvup&response_type=code&redirect_uri=https://lillapulay.github.io/meetup/';
      return null;
    }
